...
function loadDataRealtime() {
  const q = collection(db, "pengeluaran");
...
document.getElementById("exportExcelBtn").addEventListener("click", async () => {
  ...
  const promises = selectedIds.map(id => getDoc(doc(db, "pengeluaran", id)));
  ...
  XLSX.writeFile(wb, `Pengeluaran_Selected.xlsx`);
